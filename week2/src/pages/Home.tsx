  ...
  return (
    <>
        <div className="border-base-300 p-4">
            <div className="bg-base-300 flex flex-col justify-center items-center p-4">
                <h1>Bienvenue !</h1>
                <p>J'ai reçu {count} cliques</p>
                <button className="btn btn-outline btn-primary" onClick={() => setCount(count + 1)}>Compteur</button>
            </div>
            <div className="divider"></div>
            <div className="bg-base-300 place-items-center p-4">
                <form className='' onSubmit={welcome}>
                    <fieldset className="fieldset bg-base-200 border-base-300 w-xs p-8">
                    <input 
                    type="text"
                    value={name}
                    className="input"
